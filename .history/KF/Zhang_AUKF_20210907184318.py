...
class adaptiveUKF(UnscentedKalmanFilter):
    ...
    def correct_update(self, x, **kwargs):
        # re-create sigma points corresponding to updated mean and variance of hidden state at previous time point
        self.phi_c_c = self.points_fn.sigma_points(self.z_c_c, self.Pzz_c_c)
