...
class RobustUnscentedKalmanFilter(object):
    def __init__(self, dim_z, dim_x, fx, hx, points, Q, R, chi_sq_threshold = None, tune0 = None, a = None, inv = None):
        self._dim_z = dim_z
        self._dim_x = dim_x
        self.Q = Q
        self.R = R
    ...
    def predict(self, **kwargs):
        ...
        self.z, self.P = RobustUnscentedKalmanFilter.UT(
    ...
    def update(self, x, **kwargs):
        ...
        # ---------------------------------------------------------
        self.x_c_p, self.Pxx_c_p = RobustUnscentedKalmanFilter.UT(
