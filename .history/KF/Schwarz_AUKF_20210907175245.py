...
# The formulation can lead to non-positive definite output, leading to instability in the filter where inverse does not exist. For R adaptation, residual sequences (x - x_predicted)
