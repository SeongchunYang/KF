...
# For brevity, recompute of the state mean and variance were skipped. This also does mean that the effect of the current
# time innovation (or prediction error) will start affecting the filter one time step after the fact.
# 3.
