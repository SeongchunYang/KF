...
class adaptiveUKF(UnscentedKalmanFilter):
    ...
    def __init__(
        ...
        super().init(dim_z, dim_x, z0, P0, fx, hx, points_fn, Q, R)
        self.n              =   n
        self.L              =   L 
    ...
    def correct_update(self, i, x, **kwargs):
        ...
        # update final values
        self.z = self.z_updated = self.z_corrected + dot(self.K, np.subtract(x, self.xp))
        self.z = self.P_updated = self.P_corrected - dot(self.K, dot(self.S, self.K.T))
