...
class adaptiveUKF(UnscentedKalmanFilter):
    ...
    def _adaptive_updateQ(self,i):
        self.Q = np.mean(
            self.corrections_v[i-self._L,:,:],
            axis = 0
        ) + self.P - self.P_og
    
    def _adaptive_updateR(self,i):
        '''
    ...
    def _correct_updateQ(self, x, **kwargs):
        ...
        self.__correct_updateQR(x,self.z_corrected)
    
    def _correct_updateR(self, x, **kwargs):
        '''
        Correct estimates using the updated R.
        '''
        self.__correct_updateQR(x,self.z_og)
    
    def __correct_updateQR(self,x,z_corrected,**kwargs):
        '''
