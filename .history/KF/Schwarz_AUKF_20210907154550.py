...
class adaptiveUKF(UnscentedKalmanFilter):
    ...
    def _adaptive_updateR(self, i, x, **kwargs):
        '''
        While prefix '_' is used, the user is welcome to access this separately to
        implement only the Q adaptation or R adaptation. Note however that R adaptation
        has to follow Q, never the other way around.
        '''
        ### R
