...
The applications shown in this repository are of dual estimation mode and adaptive estimatino of noise covariance, namely the transition noise (Q) and the measurement noise.
