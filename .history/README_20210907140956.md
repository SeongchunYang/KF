...
The applications shown in this repository are of reparameterization of initial dual estimation mode and adaptive estimation of noise covariances, namely the transition noise (Q) and the measurement noise (R).
