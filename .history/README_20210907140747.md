...
The applications shown in this repository are of dual estimation mode and adaptive estimation of noise covariances, namely the transition noise (Q) and the measurement noise (R).

For a Kalman filter and its relatives, the major issue that arises is effective inference on initial conditions. These include estimation of 
